        ...
        files: [{
          ...
          fields: [
            ...
            { name: 'masthead', label: 'Mât', widget: 'object', required: false, fields: [
              ...
              { name: 'sports', label: 'Sports (puce mât)', widget: 'object', required: false, hint: 'Plusieurs équipes/sports : la puce alterne (~5 s, animation gare).', fields: [
                ...
                { name: 'teams', label: 'Équipes (multi-sports)', widget: 'list', required: false, summary: '{{fields.code}} · {{fields.name}} · {{fields.sport}}', fields: [
                  ...
                  { name: 'sport', label: 'Sport (slug)', widget: 'string', required: true },
                  ...
                  { name: 'results', label: 'Résultats', widget: 'list', required: false, summary: '{{fields.date}} · {{fields.opponent}}', fields: [
